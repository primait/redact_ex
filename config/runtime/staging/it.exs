...
config :redact_ex, RedactExWeb.Endpoint,
  server: true,
  url: [scheme: "https", host: "redact_ex-staging.prima.it", port: 443],
  http: [
  ...
  secret_key_base: System.get_env("secret_key_base_it_staging")
...
config :prima_auth0_ex,
  auth0_base_url: "https://prima-it-staging.eu.auth0.com"

config :prima_auth0_ex, :server,
  audience: "redact_ex",
  issuer: "https://prima-it-staging.eu.auth0.com/"
